...
export const wafflesData = [
  {
    ...
    description: "Soy",
    images: [Waffle, WaffleVegetarianHerb],
    nutrition: [
      ...
      { nutrient: "Fat", amount: "6–7 g", notes: "Mostly healthy plant fats from soy and seed oils" },
  ...
  },
  {
    ...
    description: "Vegetarian Herb",
    images: [Waffle, WaffleVegetarianHerb],
    nutrition: [
      { nutrient: "Calories", amount: "210–250 kcal", notes: "Light, energizing, and ideal as a balanced snack" },
      { nutrient: "Protein", amount: "8–10 g", notes: "From plant-based ingredients and wholesome flours" },
      { nutrient: "Fat", amount: "5–7 g", notes: "Mostly healthy fats from seeds and vegetable oils" },
      { nutrient: "Carbs", amount: "28–32 g", notes: "Slow-release carbs for steady energy" },
      { nutrient: "Fiber", amount: "4–6 g", notes: "Herbs and whole grains provide natural digestive support" },
      { nutrient: "Sugars", amount: "1–3 g", notes: "Very low; only naturally occurring sugars" },
      { nutrient: "Sodium", amount: "140–200 mg", notes: "Moderate; can be reduced for low-salt diets" },
      { nutrient: "Micronutrients", amount: " ", notes: "Herbs add antioxidants, vitamins A & K, and minerals that support immunity and overall wellness" },
    ]
  },
  {
    title: "Herbal Delight Waffle",
    calories: "250–320 kcal",
    description: "Herbal Delight",
    images: [Waffle, HerbalDelightWaffle],
    nutrition: [
  ...
  },
  {
    ...
    calories: "250–320 kcal",
    description: "Carrot",
    images: [Waffle, CarrotWaffle],
    nutrition: [
      { nutrient: "Calories", amount: "210–250 kcal", notes: "Light, naturally sweet, and perfect as a balanced snack" },
      { nutrient: "Protein", amount: "7–9 g", notes: "From grains, eggs, and milk — supports daily energy needs" },
      { nutrient: "Fat", amount: "5–7 g", notes: "Healthy fats from olive or vegetable oils" },
