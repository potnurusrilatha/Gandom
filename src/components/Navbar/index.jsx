  ...
  return (
    <div className="flex items-center gap-8">
      ...
      <div className="hidden md:flex items-center gap-8">
        <nav className="flex gap-8">
          {links.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="font-inter text-[16px] text-black hover:font-bold hover:text-primary transition-all duration-200"
            >
              {link.label}
            </a>
          ))}
        ...
        <button className="p-2 rounded hover:text-primary transition">
        ...
        <div className="absolute top-[112px] left-0 w-full bg-white shadow-md flex flex-col items-center md:hidden py-4 gap-4 z-50">
          {links.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="font-inter text-[18px] text-black hover:font-bold hover:text-primary transition-all duration-200"
